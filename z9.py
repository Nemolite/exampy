...
while marker:
    ...
    search = "-".join(map(str,timur_ruslan))
    basa = {'камень-камень': 'ничья', 'камень-ножницы': 'Тимур', 'камень-бумага': 'Руслан',
    ...
    for i in basa:
        if i==search:
            ...
            marker = True
    if marker:
        print('Вы не правильно введли исходные данные, попробуйте еще')
